...
always #10 clk = ~clk; 
code6_top_pe_2x2 in (.clk(clk),.rst(rst),.A_in_0(A_in_0),.A_in_1(A_in_1),.B_in_0(B_in_0),.B_in_1(B_in_1),.s1(s1),.s2(s2),.s3(s3),.s4(s4),.valid(valid));
